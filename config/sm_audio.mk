...
ALARM_PATH := vendor/sm/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/sm/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/sm/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/sm/prebuilt/common/media/audio/ui
